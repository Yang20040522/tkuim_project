      ...
      child: Row(children: [
            ...
            child: Stack(fit: StackFit.expand, children: [
              if (enabled)
                ExcludeFocus(
                  ...
                  src: widget.demo.modelSrcs[index],
                  autoPlay: true,
                  autoRotate: false,
                  cameraControls: false,
                  cameraOrbit: widget.demo.cameraOrbit ?? '0deg 75deg 105%',
                  cameraTarget: widget.demo.cameraTarget,
                  fieldOfView: widget.demo.fieldOfView,
        ...
        Expanded(
            child: Column(
                  ...
                  child: SingleChildScrollView(
                    ...
                    OutlinedButton(
                        onPressed: !ready
                            ? null
                            : () => command(
                                'm.cameraOrbit=${jsonEncode(widget.demo.cameraOrbit ?? '0deg 75deg 105%')}; m.fieldOfView=${jsonEncode(widget.demo.fieldOfView ?? 'auto')};'),
              ...
              FilledButton(onPressed: widget.start, child: const Text('開始訓練')),
            ])),
      ]));
}
