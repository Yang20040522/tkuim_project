enum ActionType { turnPalm, sidePinch }
...
const List<TrainingAction> kTrainingActions = [
  TrainingAction(
    ...
    difficulties: [
      DifficultyOption(level: DifficultyLevel.level1, label: 'Level 1', description: '初階 — 容錯較高'),
      DifficultyOption(level: DifficultyLevel.level2, label: 'Level 2', description: '中階 — 要求嚴格'),
    ],
  ),
  TrainingAction(
    ...
    difficulties: [
      DifficultyOption(level: DifficultyLevel.level1, label: 'Level 1', description: '初階 — 微幅側捏'),
      DifficultyOption(level: DifficultyLevel.level2, label: 'Level 2', description: '中階 — 標準動作'),
      DifficultyOption(level: DifficultyLevel.level3, label: 'Level 3', description: '進階 — 連擊模式'),
    ],
  ),
];
