...
ThemeData tvTheme() {
  final base = ThemeData(
    colorSchemeSeed: const Color(0xff2359a8),
    useMaterial3: true,
  );
  ...
  return base.copyWith(
    textTheme: base.textTheme.copyWith(
      ...
      // TextField 預設會使用 titleMedium。
      // 明確指定深色，避免 Android TV 白底白字。
    ...
    textSelectionTheme: const TextSelectionThemeData(
      cursorColor: Color(0xff2359a8),
      selectionColor: Color(0x552359a8),
      selectionHandleColor: Color(0xff2359a8),
    ),
  );
}
          ...
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              foregroundDecoration: BoxDecoration(
                ...
                border: Border.all(
                  color: focused ? const Color(0xffea8a00) : Colors.transparent,
                  width: 4,
                ),
              ),
              child: widget.child,
...
/// Leave a one-line TV input with Up/Down;
/// Left/Right still edit its value.
class TvTextNavigation extends StatelessWidget {
  final Widget child;

  const TvTextNavigation({
    super.key,
    required this.child,
  });

  @override
  Widget build(BuildContext context) => !AppPlatform.current.supportsDpad
      ? child
      : Shortcuts(
          shortcuts: const {
