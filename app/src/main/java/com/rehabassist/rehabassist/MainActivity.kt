...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // ✨ 加上第五個動作：手臂上舉訓練
        val actionOptions = arrayOf("翻掌訓練", "手部精細動作 - 側捏", "功能性擦拭訓練", "方向盤畫圓訓練", "手臂上舉訓練")
        ...
        spinnerAction.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                val difficultyOptions = when (selectedAction) {
                    ...
                    "手臂上舉訓練" -> arrayOf("Level 1 (輕度抬起)", "Level 2 (舉高至頭部)", "Level 3 (空中定格)") // ✨ 加上上舉的難度選項
